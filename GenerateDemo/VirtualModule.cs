...
namespace GenerateDemo
{
    ...
    public class VirtualModule : IModule
    {
        ...
        public IEnumerable<ITypeDefinition> TopLevelTypeDefinitions => throw new NotImplementedException();

        public IEnumerable<ITypeDefinition> TypeDefinitions => throw new NotImplementedException();
