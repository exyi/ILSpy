...
namespace GenerateDemo
{
    ...
    public class VirtualMethod : IMethod, IMethodWithDefinition
    {
        public VirtualMethod(ITypeDefinition declaringType, Accessibility accessibility, string name, IReadOnlyList<IParameter> parameters, IType returnType)
        {
